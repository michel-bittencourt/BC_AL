codeunit 50204 CarsBrandApiControllerResponse
{
    trigger OnRun()
    begin
    end;
    ...
    var
        recCarsBrandTable: Record CarsBrandTable;
    ...
    begin
        recCarsBrandTable.Reset();
        recCarsBrandTable.Init();

        recCarsBrandTable.codigo := json_Methods.GetJsonValueAsText(userInfoJsonObject, 'codigo');
        recCarsBrandTable.nome := json_Methods.GetJsonValueAsText(userInfoJsonObject, 'nome');

        recCarsBrandTable.Insert();
    end;
}